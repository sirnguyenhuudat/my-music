    ...
    $('#create_submit').on('click', function () {
        ...
        $.ajax({
            ...
            'success': function (result) {
                ...
                data_xhtml += '<td>#</td>';
                data_xhtml += '<td>' + result.role.name + '</td>';
                data_xhtml += '<td>' + result.role.display_name + '</td>';
        ...
        $('#update_submit').on('click', function () {
            ...
            $.ajax({
                ...
                'success': function (result) {
                    ...
                    $('tr[attr-num=' + id + '] td[attr-name=1]').html(result.role.name);
                    $('tr[attr-num=' + id + '] td[attr-display_name=1]').html(result.role.display_name);
