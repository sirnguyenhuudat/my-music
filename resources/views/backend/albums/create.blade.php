                    ...
                    <div class="col-lg-10 offset-lg-1">
                        <div class="card">
                            <div class="card-header">
                                {!! trans('backend_album.label_form') !!}
                            </div>
                            <div class="card-body card-block">
                                <form action="{{ route('backend.albums.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7">
                                            <div class="form-group {{ $errors->has('title') ? 'has-warning' : '' }}">
                                                ...
                                                <input type="text" class="form-control-success form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" name="title" value="{{ old('title') }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group {{ $errors->has('relate_date') ? 'has-warning' : '' }}">
                                                ...
                                                <input type="text" class="form-control-success form-control {{ $errors->has('relate_date') ? 'is-invalid' : '' }}" name="relate_date" id="relate_date">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group {{ $errors->has('info') ? 'has-warning' : 'has-success' }}">
                                        ...
                                        <textarea name="info" id="albumEditor" class="form-control {{ $errors->has('info') ? 'is-invalid' : '' }}">{{ old('info') }}</textarea>
                                    </div>
